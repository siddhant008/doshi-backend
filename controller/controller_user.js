    ...
    //get user by id
    exports.user_fetch = (req, res) => {
        try {
            console.log("UserId:: ", req.query);
            User.findAll({where: {user_id: req.query.user_id}}).then(user => {
                console.log("user with user id: ", req.query.user_id, " is", JSON.stringify(user, null, 4));
                return res.json({
                    status: 200,
                    data: user,
                    message: "user fetched successfully."
